...
.highlight-info { color: var(--color-accent); font-weight: 600; }
.highlight-email { color: var(--color-text-primary); }
...
.warning-msg {
  display: flex; align-items: center; gap: 8px;
  padding: 12px 16px;
  background: rgba(184,154,75,0.06);
...
.banned-msg {
  ...
  border: 1px solid rgba(184,80,80,0.3);
  border-radius: var(--radius-sm);
  font-size: 13px;
  color: #B85050;
}
...
.success-msg {
  display: flex; align-items: center; gap: 8px;
  padding: 12px 16px;
  background: rgba(111,143,111,0.06);
